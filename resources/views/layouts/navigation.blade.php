        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    {{-- Ubah link logo sesuai peran atau arahkan ke '/' --}}
                    <a
                        href="{{ Auth::check() ? (Auth::user()->role === 'admin' ? route('admin.dashboard') : (Auth::user()->role === 'mahasiswa' ? route('mahasiswa.dashboard') : (Auth::user()->role === 'dosen' ? route('dosen.dashboard') : '/'))) : '/' }}">
